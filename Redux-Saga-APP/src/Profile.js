...
import { fetchDataIP } from "../src/Api";
import { useNavigation } from "@react-navigation/native";
import store from "./redux-saga/store";

const Profile = () => {
  const DataIP = useSelector((state) => state.data);
      ...
      <View style={styles.infoContainer}>
        ...
        <View>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.Value}>{DataIP?.city}</Text>
          </View>

          <View style={styles.infoItem}>
            <Text style={styles.Label}>Negara Anda</Text>
            <Text style={styles.Value}>{DataIP?.country}</Text>
          </View>

          <View style={styles.infoItem}>
            <Text style={styles.Label}>Zona</Text>
            <Text style={styles.Value}>{DataIP?.timezone}</Text>
          </View>

          <View style={styles.infoItem}>
            <Text style={styles.Label}>Garis Lintang</Text>
            <Text style={styles.Value}>{DataIP?.lat}</Text>
          </View>

          <View style={styles.infoItem}>
            <Text style={styles.Label}>Garis Bujur</Text>
            <Text style={styles.Value}>{DataIP?.lon}</Text>
          </View>

          <View style={styles.infoItem}>
            <Text style={styles.Label}>ISP Anda</Text>
            <Text style={styles.Value}>{DataIP?.isp}</Text>
          </View>
        </View>

        <View style={styles.infoItem}>
          <Text style={styles.Desc}>
            Profil ini memakai Redux Saga dan API dari{" "}
